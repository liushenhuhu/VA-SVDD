...
def plot_all(x, noise, modulated_signal, x_f, noise_f, modulated_signal_f,index):
    ...
    # 保存图像到 img 目录中
    save_path = os.path.join(save_dir, 'ecg_plots'+str(index)+'.png')
