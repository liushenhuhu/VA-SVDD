...
def plot_distribution( x1,x2,label1,label2,save_dir):
    ...
    plt.savefig(save_dir+"/dist"+'.eps', dpi=330, bbox_inches='tight')
    plt.savefig(save_dir+"/dist"+'.png', bbox_inches='tight')
    fig.tight_layout()
